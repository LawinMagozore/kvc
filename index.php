...
<div class="banner-top">
	...
	<div class="contact-bnr-w3-agile">
		<ul>
			<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@KyleViewCharlets.co.zw</a></li>
			<li><i class="fa fa-phone" aria-hidden="true"></i>+263 8612 816 687</li>
			<li class="s-bar">
				<div class="search">
			...
			<div class="d-flex align-items-center " id="navbarLeftAlignExample">
				<nav class=" menu menu--iris">
					<ul class="navbar-nav">
						...
						<li class=""><a href="#contact" class="menu__link">Contact Us</a></li>
					...
					<div class="w3layouts-banner-top">
						...
						<div class="container">
							<div class="agileits-banner-info">
								<h4>Kyle View Charlets</h4>
								<h3>We know what you love</h3>
								<p>Welcome to our lodge</p>
...
<div class="about-wthree" id="about">
	<div class="container">
		<div class="ab-w3l-spa">
			<h3 class="title-w3-agileits title-black-wthree">About Our Kyle View</h3>
